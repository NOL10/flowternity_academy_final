...
export const SPORTS = [
  ...
  { id: 'futsal', name: 'Futsal', status: 'active', description: 'Fast-paced 5-a-side football on a. outdoor synthetic flooring.', tagline: 'Indoor · 5-a-side', image: 'https://images.unsplash.com/photo-1552667466-07770ae110d0?auto=format&fit=crop&q=80&w=1200' },
...
export const MEMBERSHIPS = [
  ...
  { id: 'basketball_1m',  name: 'Basketball', sport_id: 'basketball', duration_months: 1,  price: 3102,  popular: false, pause_days: 0 },
  ...
  { id: 'skateboarding_1m', name: 'Skateboarding', sport_id: 'skateboarding', duration_months: 1, price: 1, pause_days: 0 },
